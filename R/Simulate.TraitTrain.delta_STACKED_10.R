#' Simulate.TraitTrain.delta_STACKED_10: Function to simulate trait data under the STACK (+lrates) delta model
#'
...
#' 
#' ################################################################
#' # simulate under delta model with STACKED 10 (delta + lrates ) #
#' ################################################################
#' Simulate.TraitTrain.delta_STACKED_10(handle.Phylogeny = handle.PrimatePhylogeny, 
...
#########################################
# Simulate.TraitTrain.delta_STACKED_10 #
#########################################
Simulate.TraitTrain.delta_STACKED_10 <- function(handle.Phylogeny, numeric.Sig2, numeric.delta, numeric.AncestralState, vector.STACK_lrate_nodes, vector.STACK_lrate_rates, matrix.R){
