#' Simulate.TraitTrain.kappa_00: Function to simulate trait data under the kappa model
#'
...
#' @param numeric.kappa Numeric value of the kappa parameter of the kappa model
...
#' 
#' ##########################################
#' ## simulate under kappa model with kappa #
#' ##########################################
#' Simulate.TraitTrain.kappa_00(handle.Phylogeny = handle.PrimatePhylogeny, 
...
################################
# Simulate.TraitTrain.kappa_00 #
################################
Simulate.TraitTrain.kappa_00 <- function(handle.Phylogeny, numeric.Sig2, numeric.kappa, numeric.AncestralState, matrix.R){
