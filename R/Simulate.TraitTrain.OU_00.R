#' Simulate.TraitTrain.OU_00: Function to simulate trait data under OU model
#'
...
#' 
#' ###########################
#' # simulate under OU model #
#' ###########################
#' Simulate.TraitTrain.OU_00(handle.Phylogeny = handle.PrimatePhylogeny, 
...
#############################
# Simulate.TraitTrain.OU_00 #
#############################
Simulate.TraitTrain.OU_00 <- function(handle.Phylogeny, numeric.Sig2, numeric.Alpha, numeric.AncestralState, matrix.R){
