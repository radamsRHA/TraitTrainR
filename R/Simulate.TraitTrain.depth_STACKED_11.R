#' Simulate.TraitTrain.depth_STACKED_11: Function to simulate trait data under the STACK (lrates + shifted) depth model
#'
...
#' 
#' #######################################################################
#' # simulate under depth model with STACKED 11 (BM + lrates + AncShift) #
#' #######################################################################
#' Simulate.TraitTrain.depth_STACKED_11(numeric.NumberOfSpecies = length(handle.PrimatePhylogeny$tip.label), 
...
#######################################
# Simulate.TraitTrain.depth_STACKED_11 #
########################################
Simulate.TraitTrain.depth_STACKED_11 <- function(numeric.NumberOfSpecies, handle.Phylogeny, numeric.depth, numeric.AncestralState, vector.STACK_lrate_nodes, vector.STACK_lrate_rates, vector.STACK_AncShiftNode, vector.STACK_AncShiftValue, matrix.R){
