#' Simulate.TraitTrain.BM_00: Function to simulate trait data under the BM model
#'
...
#' ###########################
#' Simulate.TraitTrain.BM_00(handle.Phylogeny = handle.PrimatePhylogeny, 
...
#############################
# Simulate.TraitTrain.BM_00 #
#############################
Simulate.TraitTrain.BM_00 <- function(handle.Phylogeny, numeric.Sig2, numeric.AncestralState,  matrix.R){
