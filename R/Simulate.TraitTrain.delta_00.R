#' Simulate.TraitTrain.delta_00: Function to simulate trait data under the delta model
#'
...
#' 
#' ##############################
#' # simulate under delta model #
#' ##############################
#' Simulate.TraitTrain.delta_00(handle.Phylogeny = handle.PrimatePhylogeny, 
...
################################
# Simulate.TraitTrain.delta_00 #
################################
Simulate.TraitTrain.delta_00 <- function(handle.Phylogeny, numeric.Sig2, numeric.delta, numeric.AncestralState, matrix.R){
  ...
  # simulate trait #
  ##################
  matrix.TraitData <- as.matrix(geiger::sim.char(phy = handle.Phylogeny_TRANSFORM_delta, par = matrix.R, nsim = 1, model = "BM", root = numeric.AncestralState)[,,1])
