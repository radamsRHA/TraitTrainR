#' Simulate.TraitTrain.trend_00: Function to simulate trait data under the trend model
#'
...
#' ##########################################################################
#' Simulate.TraitTrain.trend_00(handle.Phylogeny = handle.PrimatePhylogeny, 
...
################################
# Simulate.TraitTrain.trend_00 #
################################
Simulate.TraitTrain.trend_00 <- function(handle.Phylogeny, numeric.Sig2, numeric.AncestralState, numeric.slope, matrix.R){
