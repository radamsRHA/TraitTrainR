#' Simulate.TraitTrain.kappa_STACKED_10: Function to simulate trait data under the STACK (lrates) kappa model
#'
...
#' 
#' ##################################################################
#' ## simulate under kappa model with STACKED 10 (kappa + lrates ) #
#' ##################################################################
#' Simulate.TraitTrain.kappa_STACKED_10(handle.Phylogeny = handle.PrimatePhylogeny, 
...
########################################
# Simulate.TraitTrain.kappa_STACKED_10 #
########################################
Simulate.TraitTrain.kappa_STACKED_10 <- function(handle.Phylogeny, numeric.Sig2, numeric.kappa, numeric.AncestralState, vector.STACK_lrate_nodes, vector.STACK_lrate_rates, matrix.R){
